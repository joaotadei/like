import{t as d}from"./index-2ac6b6ac.js";class u extends HTMLElement{constructor(){super(),this.build()}build(){const e=document.createElement("footer");e.classList.add("page-footer"),e.innerHTML=`
