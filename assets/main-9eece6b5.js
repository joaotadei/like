import"./modulepreload-polyfill-ec808ebb.js";import"./menu-20eae783.js";import{S as u}from"./MockServer-1f629502.js";import"./index-2ac6b6ac.js";const d=new u,a=document.querySelector("#trainee-section button.btn-see-more"),r=document.querySelector("#internship-section button.btn-see-more");let c=[],o=[];a.addEventListener("click",l);r.addEventListener("click",m);p().then(()=>m());h().then(()=>l());function l(){a.disabled=!0;const t=document.querySelector("#trainee-items"),s=[];t.querySelectorAll("div.card").forEach(e=>s.push(e.dataset.id)),c.filter(e=>!s.includes(e.id)).forEach((e,i)=>{if(i>(s.length>0?3:7))return a.disabled=!1;const n=document.createElement("div");n.classList.add("card"),n.innerHTML+=`
